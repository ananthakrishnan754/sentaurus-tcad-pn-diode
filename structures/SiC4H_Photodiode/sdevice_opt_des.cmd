* ============================================================
* FILE:    structures/SiC4H_Photodiode/sdevice_opt_des.cmd
* TOOL:    Sentaurus Device (SDevice)
* PURPOSE: Optical Illumination & Photocurrent Simulation for 4H-SiC PIN Photodiode
* ============================================================

File {
    Grid    = "SiC4H_Photodiode_msh.tdr"
    Plot    = "SiC4H_Photodiode_opt_des.tdr"
    Current = "SiC4H_Photodiode_opt_des.plt"
}
...
Solve {
    ...
    * 2. Reverse Bias Sweep under Top Illumination (V = 0 V to -3.0 V)
    ...
    Plot (FilePrefix = "SiC4H_Photodiode_opt_rev")
}
