...
;; PURPOSE: Define 2D PIN Light Emitting Diode (LED) for GaAs
;; ============================================================
...
;; 2. Region Definitions - GaAs Material
(sdegeo:create-rectangle (position xmin ymin 0) (position xmax y_p_i 0) "GaAs" "P_Region")
(sdegeo:create-rectangle (position xmin y_p_i 0) (position xmax y_i_n 0) "GaAs" "I_Active_Region")
(sdegeo:create-rectangle (position xmin y_i_n 0) (position xmax ymax 0) "GaAs" "N_Region")
...
(sdegeo:set-contact-edges (find-edge-id (position 0.5 0.5 0)))
