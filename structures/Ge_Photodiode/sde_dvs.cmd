...
;; PURPOSE: Define 2D PIN Photodiode Structure for Germanium (Ge)
;; ============================================================
...
;; 2. Region Definitions - Germanium Material
(sdegeo:create-rectangle (position xmin ymin 0) (position xmax y_p_i 0) "Germanium" "P_Region")
(sdegeo:create-rectangle (position xmin y_p_i 0) (position xmax y_i_n 0) "Germanium" "I_Region")
(sdegeo:create-rectangle (position xmin y_i_n 0) (position xmax ymax 0) "Germanium" "N_Region")
