;; ============================================================
;; FILE:    structures/Ge_Photodiode/sde_dvs.cmd
;; TOOL:    Sentaurus Structure Editor (SDE)
;; PURPOSE: Define 3D Bulk PIN Photodiode Structure for Germanium (Ge)
;; ============================================================
...
;; 2. Region Definitions - 3D Germanium Bulk Material
(sdegeo:create-cuboid (position xmin ymin zmin) (position xmax y_p_i zmax) "Germanium" "P_Region")
(sdegeo:create-cuboid (position xmin y_p_i zmin) (position xmax y_i_n zmax) "Germanium" "I_Region")
(sdegeo:create-cuboid (position xmin y_i_n zmin) (position xmax ymax zmax) "Germanium" "N_Region")
...
(sde:build-mesh "snmesh" "" "Ge_Photodiode_msh")
(sde:save-model "Ge_Photodiode")
